    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6">
      ...
      <div className="w-full max-w-md bg-white rounded-2xl border border-slate-200 shadow-premium p-8 relative overflow-hidden">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="font-bold text-2xl tracking-tight text-slate-900 font-outfit">Staff Portal</h2>
          <p className="text-xs text-slate-500 mt-1">Sign in with your RepairFlow credentials</p>
        </div>
        ...
        <div className="mt-8 pt-6 border-t border-slate-100 text-center">
          <Link href="/" className="text-xs text-slate-400 hover:text-slate-600 hover:underline">
