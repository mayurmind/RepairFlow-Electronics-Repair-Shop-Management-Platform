...
export const ApiStandardErrors = () =>
  applyDecorators(
    ApiUnauthorizedResponse({ type: ApiValidationErrorDto, description: "Authentication required" }),
    ApiForbiddenResponse({ type: ApiValidationErrorDto, description: "Insufficient permissions or wrong branch" }),
    ApiNotFoundResponse({ type: ApiValidationErrorDto, description: "Resource not found" }),
    ApiConflictResponse({ type: ApiValidationErrorDto, description: "Business rule violation or state conflict" }),
  );
