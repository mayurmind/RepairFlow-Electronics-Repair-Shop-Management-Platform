...
export class CustomersController {
  ...
  async create(
    ...
    const customer = await this.customersService.create(body, actor);
  ...
  async findAll(
    ...
    const result = await this.customersService.findAll(query, actor);
  ...
  async findOne(
    ...
    const customer = await this.customersService.findOne(id, actor);
    return { success: true as const, data: customer };
  }
  ...
  async update(
    ...
    const customer = await this.customersService.update(id, body, actor);
    return { success: true as const, data: customer };
  }
  ...
  async getDevices(
    ...
    const devices = await this.customersService.getDevices(id, actor);
  ...
  async getRepairHistory(
    ...
    const history = await this.customersService.getRepairHistory(id, actor);
